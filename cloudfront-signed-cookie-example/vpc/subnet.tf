# subnet
resource "aws_subnet" "scenario_6_public_1" {
...
resource "aws_subnet" "scenario_6_public_2" {
  vpc_id = aws_vpc.scenario_6.id
...
resource "aws_subnet" "scenario_6_public_3" {
  vpc_id = aws_vpc.scenario_6.id
...
resource "aws_subnet" "scenario_6_private_1" {
  vpc_id = aws_vpc.scenario_6.id
...
resource "aws_subnet" "scenario_6_private_2" {
  vpc_id = aws_vpc.scenario_6.id
