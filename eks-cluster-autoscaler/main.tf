...
module "launch_template" {
  ...
  tuna-eks-cluster_name = module.eks.tuna-eks-cluster_name
  tuna-eks-cluster_ca = module.eks.tuna-eks-cluster_ca
  tuna-eks-cluster_endpoint = module.eks.tuna-eks-cluster_endpoint
}
